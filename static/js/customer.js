$( document ).ready(function() {
    ...
    $("#add_new").on("click", function(e) {
        e.preventDefault();
        add_address_send_ajax()
    });
    function add_address_send_ajax(){
        ...
        $.ajax({
            type: 'POST',
            url: '/branche/order/all', //ddddddddddddddddddddddddddddddd
            dataType: 'json',
            data:data,
            beforeSend:function(e){
                $('#address_list').html('loading....')
            },
            success: function(res) {
                console.log(res.data)
                $('#address_list').html(res.data)
            }
        });
    }
