...
class ManagerSignup (View):
    def get(self, request):
        ...
        return render (request, 'restaurant/manager/manager_signup.html' ,{'category_list' : categories })
    ...
    def post(self, request):
        ...
        if not error_message :
            ...
            user =  authenticate(request,username=manager.username, password=password)
            login(request, user)
            ...
            return render (request, 'restaurant/manager/manager_signup.html', data)
